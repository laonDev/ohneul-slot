...
> 앱인토스 6월 바이브코딩 챌린지 출품작. 최종 업데이트: **2026-06-24**
> 상태: **✅ 출품 완료 — 검수 중** (마감 6/30, 6일 전 제출)
...
- [x] `.ait` 빌드 + 배포 (`ohneul-slot-1.ait`, 4.3MB, deploymentId 발급)
- [x] 콘솔 정보·자산 입력 (로고/썸네일/스크린샷/설명/키워드)
- [x] 챌린지 신청폼 작성 (한글명/appName/설명/주제 연관성)
- [x] **검토 요청 완료**
- [ ] 검수 통과 (1~2영업일) → 출시 → 7월 AU 집계
