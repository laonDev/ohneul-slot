...
> 앱인토스 6월 바이브코딩 챌린지 출품작. 최종 업데이트: **2026-06-26**
> 상태: **✅ 앱 정보 승인 + 번들 검수 요청 완료 — 검수 대기** (최대 3영업일)
...
- [x] **번들 검토 요청 완료** (6/26) — 검수 최대 3영업일
- [ ] 검수 통과(이메일) → 콘솔 **"출시하기"** 클릭 → 출시
- [ ] 7/1~7/26 AU 집계

### ⚠️ 알려진 보류 항목
- 헤더 🔔 점심 알림 토글: 콘솔 푸시 템플릿 코드 미연결(`LUNCH_PUSH_TEMPLATE_CODE=''`)이라 현재 미작동 → 다음 버전에서 연결 또는 임시 숨김
